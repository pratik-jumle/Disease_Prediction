...
gdrive_url = "https://drive.google.com/file/d/1buYks2_jvTJpAU7PWLXlAC3qBYBYoWzR/view?usp=sharing"

# Ensure model directory exists
os.makedirs("model", exist_ok=True)

# Download model if not present
model_path = "model/mango_leaf_classification_model_weights_omdena_resnet50.hdf5"
